...
const shared_esmBundler = require("../../../node_modules/.pnpm/@vue_shared@3.4.30/node_modules/@vue/shared/dist/shared.esm-bundler.js");
const useClick = ({
  handleClick,
  handleMousedown,
  handleMouseup
  ...
  let onMouseup;
  if (!handleClick) {
    onClick = onMousedown = onMouseup = shared_esmBundler.NOOP;
  } else {
